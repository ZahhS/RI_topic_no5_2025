    ...
    def get_query_vector(self, query, expansion=None):
        ...
        if expansion is not None:
            ...
            if not relevant_texts:
                # Pas de documents pertinents => on retourne le vecteur de la requête brute
                return q
            ...
            non_relevant_texts = [self.dataset["documents"][doc_id] for doc_id in non_relevant_ids]
    
            if not non_relevant_texts:
                return q
